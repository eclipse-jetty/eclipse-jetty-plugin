...
public class Jetty7LauncherMain
{
	public static void main(final String[] args) throws Exception
	{
		...
		{
			System.out
				.println("Usage: java Jetty7LauncherMain -port {port} -context {context} -webapp {path to webapp}");
			return;
		}
	...
	public static void launch(final int port, String contextPath, final String webappPath) throws Exception
	{
		...
		final WebAppContext context = new WebAppContext(webappPath, contextPath);
