...
public class ExtendedAnnotationConfiguration extends AnnotationConfiguration
{
    ...
    public void configure(WebAppContext context) throws Exception
    {
        ...
        System.out.println(metadataComplete);
        System.out.println(context.getServletContext().getEffectiveMajorVersion());
        System.out.println(context.isConfigurationDiscovered());
